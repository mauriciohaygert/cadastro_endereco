...
<form method="post">
   ...
   <div class="form-row">
    <div class="col-md-7 mb-3">
        ...
        <input type="text" class="form-control" name="endereco" id="endereco" maxlength="45" required>
    </div>
    <div class="col-md-2 mb-3">
        <label for="numero" class="">Número</label>
        <input type="text" class="form-control" name="numero" id="numero" maxlength="40" maxlength="15" required>
    </div>
    <div class="col-md-3 mb-3">
